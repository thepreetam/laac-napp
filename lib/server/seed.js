...
const DEMO_USERS = [
  { email: 'demo@lawschool.edu', password: 'demo1234', firstName: 'Maya', lastName: 'Ruiz', persona: 'student' },
  { email: 'hr@baylegal.org', password: 'demo1234', firstName: 'Sarah', lastName: 'Chen', persona: 'employer' },
  { email: 'admin@laac.org', password: 'demo1234', firstName: 'Admin', lastName: 'LAAC', persona: 'admin' },
]
...
async function seed(store) {
  const seeded = await store.get('pipeline-seeded-v1')
  ...
  // Set seeded flag
  await store.set('pipeline-seeded-v1', true)
